    ...
    <Box display={"flex"} justifyContent={"center"}>
      <Box maxW={"800px"} width={"100%"}>
        ...
        <p>
          ...
          use of {siteData.appName}'s Website, located at
          {siteData.appName}.
        </p>
        <br />
        ...
        <p>
          ...
          conditions. Do not continue to use {siteData.appName} if you do not
        ...
        <br />
        <p>
          Unless otherwise stated, {siteData.appName} and/or its licensors own
          the intellectual property rights for all material on{" "}
          {siteData.appName}. All intellectual property rights are reserved. You
          may access this from {siteData.appName} for your own personal use
        ...
        <ul>
          ...
          <li>Sell, rent or sub-license material from {siteData.appName}</li>
          <li>Reproduce, duplicate or copy material from {siteData.appName}</li>
        ...
        <p>
          ...
          {siteData.appName} does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of {siteData.appName},its agents and/or affiliates.
        ...
        <br />
        <p>
          {siteData.appName} reserves the right to monitor all Comments and to
        ...
        <br />
        <p>
          You hereby grant {siteData.appName} a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of {siteData.appName}; and (d)
        ...
        <p>
          ...
          sending an e-mail to {siteData.appName}. Please include your name,
        ...
        <p>
          No use of {siteData.appName}'s logo or other artwork will be allowed
